...
- **Visible-Only Extraction**: Dynamically filters out hidden elements (SPA history, hidden tabs, etc) to capture only what the user sees
- **Iframe Support**: Extracts and includes content from embedded iframes when accessible
- **Debug Mode**: Inspect the raw HTML extracted from the page for troubleshooting
